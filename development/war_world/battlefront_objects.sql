...
--
-- Table structure for table `battlefront_objects`
--
...
--
-- Dumping data for table `battlefront_objects`
--

LOCK TABLES `battlefront_objects` WRITE;
/*!40000 ALTER TABLE `battlefront_objects` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlefront_objects` ENABLE KEYS */;
UNLOCK TABLES;
